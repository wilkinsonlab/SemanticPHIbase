...
public class PhiEntry {
	...
	private String identifierTypeProteinID;
	...
	public void setIdentifierTypeProteinID(String t) {
		this.identifierTypeProteinID = t;
	}
	
	public String getIdentifierTypeProteinID() {
		return this.identifierTypeProteinID;
	}
	
	public void setIdentifierTypeGeneLocusID(String t) {
		this.identifierTypeGeneLocusID = t;
	}
	
	public String getIdentifierTypeGeneLocusID() {
		return this.identifierTypeGeneLocusID;
	}
